...
- **proagent** - Data scientist role definitions, EDA skills, data visualization, analytics infrastructure
- **casdk-harness** - PostgreSQL expert and SQL expert agent configurations
- **agents** - dbt transformation patterns, data engineering plugins, business analytics
- **awesome-claude-skills** - Spreadsheet manipulation and data processing skills
- **specs** - Data role implementations and analytics specifications
